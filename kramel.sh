...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	then
		...
		git clone --depth=1 https://github.com/GhostMaster69-dev/Cosmic-Clang clang-llvm
		# Toolchain Directory defaults to clang-llvm
		TC_DIR=$KERNEL_DIR/clang-llvm
	fi

	msg "|| Cloning Anykernel ||"
	git clone --depth 1 --no-single-branch https://github.com/KrishnakantShedge/AnyKernel3.git -b master
	msg "|| Cloning libufdt ||"
...
if [ $LOG_DEBUG = "1" ]
then
	tg_post_build "error.log" "Debug Mode Logs"
fi
